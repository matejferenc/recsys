...
public class ItemAverageEvaluator {

	public static void main(String[] args) throws Exception {
		ItemAverageEvaluator e = new ItemAverageEvaluator();
		e.execute();
	}
...
//		DataModel dataModel = new FileDataModel(dataFile, "\t");
		...
		ItemAverageRecommenderBuilder recommenderBuilder = new ItemAverageRecommenderBuilder();
