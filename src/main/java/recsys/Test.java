...
//		File dataFile = new File("src/main/resources/datasets/movielens/ml-1m/ratings.dat");
		...
		Recommender recommender = new GenericUserBasedRecommender(model, neighborhood, userSimilarity); Recommender cachingRecommender = new CachingRecommender(recommender);
