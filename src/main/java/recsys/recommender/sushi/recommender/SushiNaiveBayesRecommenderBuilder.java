...
public class SushiNaiveBayesRecommenderBuilder implements RecommenderBuilder {

	private final SushiDataModel sushiDataModel;

	public SushiNaiveBayesRecommenderBuilder(SushiDataModel sushiDataModel) {
	...
	public Recommender buildRecommender(DataModel dataModel) throws TasteException {
		...
		return new SushiNaiveBayesRecommender(dataModel, userModel, sushiDataModel);
	}
