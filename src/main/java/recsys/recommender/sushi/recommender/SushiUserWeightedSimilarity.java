...
public class SushiUserWeightedSimilarity implements UserSimilarity {
	...
	public SushiUserWeightedSimilarity(SushiUserModel userModel, EnumSet<Include> includeProperties) {
	...
	private double computeSimilarity(long userID1, long userID2) {
		...
		double userSimilarity = (includeProperties.contains(Include.STYLE) ? calculateStyleSimilarity(user1, user2) * calculateStyleWeight(user1, user2) : 0) +
				(includeProperties.contains(Include.MAJOR) ? calculateMajorGroupSimilarity(user1, user2) * calculateMajorGroupWeight(user1, user2) : 0) +
				(includeProperties.contains(Include.MINOR) ? calculateMinorGroupSimilarity(user1, user2) * calculateMinorGroupWeight(user1, user2) : 0) +
				(includeProperties.contains(Include.OILINESS) ? calculateOilinessSimilarity(user1, user2) * calculateOilinessWeight(user1, user2) : 0) +
				(includeProperties.contains(Include.PRICE) ? calculatePriceSimilarity(user1, user2) * calculatePriceWeight(user1, user2) : 0) +
