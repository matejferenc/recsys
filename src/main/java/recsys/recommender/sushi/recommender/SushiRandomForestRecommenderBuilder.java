...
public class SushiRandomForestRecommenderBuilder implements RecommenderBuilder {

	private final SushiDataModel sushiDataModel;

	public SushiRandomForestRecommenderBuilder(SushiDataModel sushiDataModel) {
	...
	public Recommender buildRecommender(DataModel dataModel) throws TasteException {
		...
		return new SushiRandomForestRecommender(dataModel, userModel, sushiDataModel);
	}
