 ...
 */
public abstract class TopKRecommenderEvaluator implements RecommenderEvaluator {
		...
		public Void call() throws TasteException {
			for (Preference realPref : prefs) {
				...
				try {
					...
					estimatedPreference = recommender.estimatePreference(testUserID, itemID);
				...
				if (Float.isNaN(estimatedPreference)) {
					...
					processOneEstimate(itemID, estimatedPreference, realPref);
				}
			}
			return null;
		}
