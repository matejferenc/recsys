...
public class ItemUserAverageEvaluator {

	public static void main(String[] args) throws Exception {
		ItemUserAverageEvaluator e = new ItemUserAverageEvaluator();
		e.execute();
	}
...
//		DataModel dataModel = new FileDataModel(dataFile, "\t");
		...
		RecommenderBuilder recommenderBuilder = new ItemUserAverageRecommenderBuilder();
