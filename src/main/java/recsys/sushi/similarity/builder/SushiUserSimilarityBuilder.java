...
public class SushiUserSimilarityBuilder implements UserSimilarityBuilder {
	...
	public SushiUserSimilarityBuilder(SushiItemDataModel sushiDataModel, EnumSet<IncludeProperties> includeProperties) {
	...
	public UserSimilarity build(DataModel dataModel) throws TasteException {
		...
		return new SushiUserSimilarity(userModel, includeProperties);
	}
