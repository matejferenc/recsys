...
public class SushiUserWeightsSimilarityBuilder implements UserSimilarityBuilder {
	...
	public SushiUserWeightsSimilarityBuilder(SushiItemDataModel sushiDataModel, EnumSet<IncludeProperties> includeProperties) {
	...
	public UserSimilarity build(DataModel dataModel) throws TasteException {
		...
		return new SushiUserWeightsSimilarity(userModel, includeProperties);
	}
