...
import recsys.evaluator.OldRecommenderFairEvaluator;
 ...
 *
 */
public abstract class OldAbstractRecommenderFairEvaluator implements OldRecommenderFairEvaluator {
	...
	protected OldAbstractRecommenderFairEvaluator() {
	...
	public double evaluate(RecommenderBuilder recommenderBuilder, DataModel dataModel, double trainingPercentage, double evaluationPercentage) throws TasteException {
		...
		logPrefsStatistics(trainingPrefs, testPrefs);
	...
	protected abstract void logPrefsStatistics(FastByIDMap<PreferenceArray> trainingPrefs, FastByIDMap<PreferenceArray> testPrefs);
